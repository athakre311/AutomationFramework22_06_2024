...
public class Base {
	...
	public WebDriver initializaBrowserAndOpenApplication(String browserName) {
		...
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(Utilities.pageLoadTime1));
